...
# TODOOOOOOOOOOOOOO: https://github.com/a-martyn/resnet/blob/master/resnet.py
...
def training(local_rank):
    ...
    model = ConvVae(in_channels=39, hidden_layer_dimensions=5, out_channels=39)
...
if __name__ == '__main__':
    ...
    for jj in range(20):
        ...
        if jj == 0:
            ...
            SCHEDULER = False
        for MODEL_ID in ['cell_dataset_ome']:
            DETECT_ANOMALY = False
            OVERLAY_TRAINING_AND_VALIDATION_IN_TENSORBOARD = True
            MAX_EPOCHS = 40
            # ----------------------------------------
            model_name = 'vae'
            if MODEL_ID == 'cell_dataset_ome':
