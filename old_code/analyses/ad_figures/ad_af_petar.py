...
from old_code.data2 import OmeDataset, quantiles_for_normalization
...
from old_code.data2 import ExpressionFilteredDataset
...
if True:
    ...
    from old_code.graphs import get_graph_file
